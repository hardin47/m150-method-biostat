...
Information about the data can be found in this <a href = "https://m150-method-biostat.netlify.app/handout/HELP-baseline.pdf" target = "_blank">questionaire</a> (apologies for the poor photocopy!) as well as at `?HELPfull` which is in the **mosaic** package (`library(mosaic)`).
