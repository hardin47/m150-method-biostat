...
## Assignment
The analysis should be done in a complete R Markdown file and posted to your Canvas dropbox.   The final report should address the following tasks below but should not enumerate the tasks.  See below for grading rubric which speaks to how the report should be communicated.
