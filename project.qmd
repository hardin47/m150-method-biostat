...
3. Something new.  Each individual in the class will learn a new idea related to survival analysis (see below).   The new part will be assessed (in person!!) on your ability to explain the new idea.  That is, you must indicate a complete understanding of the topic as well as an adequate use of the method applied to the dataset. Sometime during the last week or classes or during finals week, you will have an appointment to describe your new idea in person. You are welcome to bring in any notes you might have on the topic.
