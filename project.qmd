...
More info on the final project soon!
...
### Due Dates
* **Wednesday, April 23**. Post to Canvas both the Quarto file and the corresponding pdf document:  
...
* (Optional) **Monday, May 5**. If you would like me to look at / provide feedback for a completed rough draft, you should turn in the completed draft before May 1st. (If you are a graduating senior who would like feedback, please provide me a draft by **Friday, May 2nd**.)
...
* **Friday, May 16**.  Complete assignment is due (turn in **both** the qmd and knitted pdf to Canvas). (If you are a graduating senior, the final assignment is due by **noon on Thursday, May 8**.)

## Assignment
The analysis should be done in a complete Quarto file and posted to your Canvas dropbox.   The final report should address the following tasks below but should not enumerate the tasks.
...
## R thoughts
* Use Quarto to create a reproducible analysis.  Anyone should be able to run your analysis using only the .qmd file.
