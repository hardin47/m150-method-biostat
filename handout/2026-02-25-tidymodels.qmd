...
<div class = "fragment">
1.  Data / statistical modeling: The analysis in this culture starts with assuming a stochastic data model for the inside of the black box...The values of the parameters are estimated from the data and the model then used for information and/or prediction.  **The goal is to understand the model.**

2.  Algorithmic / computational modeling: The analysis in this culture considers the inside of the box complex and unknown. The approach is to find a function f(x) --- an algorithm that operates on x to predict the responses y. **The goal is to produce excellent predictions.**
...
1.  <p style="color: #D3D3D3;">Data / statistical modeling: The analysis in this culture starts with assuming a stochastic data model for the inside of the black box...The values of the parameters are estimated from the data and the model then used for information and/or prediction.  **The goal is to understand the model.**</p>
...
> Use domain knowledge to create relevant variables from raw data.
...
> sensitivty = proportion of squirrels that are accurately predicted to be squirrels (true positive rate)

> specificity = proportion of non-squirrels that are accurately predicted to be non-squirrels (true negative rate)
...
> "second" means that a **success** happens with the second level of the variable (here: "squirrels" is alphabetically after "no squirrels")
...
## Different predictions for test data
