...
## Accuracy for different prediction cutoff
...
rbind(accuracy(data = feeder_test_pred, truth = squirrels, estimate = .pred_class),
      sensitivity(data = feeder_test_pred, truth = squirrels, estimate = .pred_class),
      specificity(data = feeder_test_pred, truth = squirrels, estimate = .pred_class))
```
