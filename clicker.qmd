...
(@) How many parameters did we estimate in the HERS warm-up with the interaction model?[^51]
     a. 3
     b. 4
     c. 6
     d. 7
...
(@) What are the df for the LRT addressing whether interaction is needed in the HERS warm-up?[^52]
     a. 2
     b. 3
     c. 2760
     d. 2754
