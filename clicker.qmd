...
[^73c]: d. or e. Hard to say, could have removed `Incubate`, `Nestling`, or `Totcare`.  (I removed `Nestling`.)
...
[^73d]: c. `Color` has the smalles test statistic and correspondingly largest p-value.
...
[^117]: d. all of the above. We restrict our analysis to a situation of controling the type I error. However, that isn't why we **want** to stop early. We **want** to stop early for the other reasons listed.
