...
[^69]: c. blue because it is farther from y=x
...
79. In a nested F test, the reduced model corresponds to the null hypothesis being true.[^79]
    (a) TRUE
    (b) FALSE
...
80.  In a nested F test, the full model corresponds to the alternative hypothesis being true.[^80]
     (a) TRUE
     (b) FALSE
